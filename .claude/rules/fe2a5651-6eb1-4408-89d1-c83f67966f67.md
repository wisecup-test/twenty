<rule_activation id="fe2a5651-6eb1-4408-89d1-c83f67966f67" title="Standardize Test Utilities in Dedicated __tests__ Directories: Test Files Utility" applies_to="**/*">
These rules are ALWAYS ACTIVE for all test file organization and utility function placement within the codebase.
</rule_activation>

### Rules

- **R-TEST-001** MUST: Test files for utility functions MUST be placed in a __tests__ directory adjacent to the source code being tested.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All test files MUST comply with the __tests__ directory structure before code is accepted.
</enforcement>