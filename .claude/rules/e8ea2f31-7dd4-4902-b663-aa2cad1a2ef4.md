<rule_activation id="e8ea2f31-7dd4-4902-b663-aa2cad1a2ef4" title="Standardize Test Utilities in Dedicated __tests__ Directories: Test Files Use" applies_to="**/*">
These rules are ALWAYS ACTIVE for all test file organization and utility function placement within the codebase.
</rule_activation>

### Rules

- **R-TEST-001** MUST: Test files MUST use the .test.ts or .test.tsx extension to be recognized by the test runner
...
# Verify Jest discovers test files with correct naming convention
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All test files MUST comply with R-TEST-001 before code is considered ready for merge.
</enforcement>