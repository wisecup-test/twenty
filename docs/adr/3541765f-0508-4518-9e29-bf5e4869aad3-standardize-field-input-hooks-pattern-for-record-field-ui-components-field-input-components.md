...
1. SHOULD: Field input components SHOULD be implemented as separate components in the 'components' directory parallel to the 'hooks' directory

## Policy Block

- SHOULD Field input components SHOULD be implemented as separate components in the 'components' directory parallel to the 'hooks' directory
