# Standardize Field Input Hooks Pattern for Record Field UI Components: Each Field Type
...
1. MUST: Each field type (Files, RelationOneToMany, RelationFromMany, MorphRelationManyToOne, MorphRelationOneToMany, RelationToOne) MUST have a corresponding dedicated hook

## Policy Block

- MUST Each field type (Files, RelationOneToMany, RelationFromMany, MorphRelationManyToOne, MorphRelationOneToMany, RelationToOne) MUST have a corresponding dedicated hook
