# Adopt Jest as Standard Testing Framework for TypeScript Components: Test Files Located
...
1. MUST: Test files MUST be co-located with the source code they test, following the pattern: src/<module>/__tests__/<filename>.test.ts

## Policy Block

- MUST Test files MUST be co-located with the source code they test, following the pattern: src/<module>/__tests__/<filename>.test.ts
