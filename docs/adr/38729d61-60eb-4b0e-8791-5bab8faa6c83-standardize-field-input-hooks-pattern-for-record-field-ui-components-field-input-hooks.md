...
1. MUST: Field input hooks MUST be located in the 'hooks' directory within the meta-types/input module structure

## Policy Block

- MUST Field input hooks MUST be located in the 'hooks' directory within the meta-types/input module structure
