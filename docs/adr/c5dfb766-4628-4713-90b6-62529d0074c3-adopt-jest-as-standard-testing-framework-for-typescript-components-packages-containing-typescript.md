# Adopt Jest as Standard Testing Framework for TypeScript Components: Packages Containing Typescript
...
1. MUST: All packages containing TypeScript code MUST include Jest configuration and dependencies in their package.json

## Policy Block

- MUST All packages containing TypeScript code MUST include Jest configuration and dependencies in their package.json
