...
1. SHOULD: Field input hooks SHOULD encapsulate all state management and interaction logic specific to that field type

## Policy Block

- SHOULD Field input hooks SHOULD encapsulate all state management and interaction logic specific to that field type
