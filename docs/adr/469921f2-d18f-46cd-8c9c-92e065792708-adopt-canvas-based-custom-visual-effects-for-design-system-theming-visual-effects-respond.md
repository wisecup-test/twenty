# Adopt Canvas-Based Custom Visual Effects for Design System Theming: Visual Effects Respond
...
1. SHOULD: Visual effects SHOULD respond to theme changes and viewport resizing through appropriate event listeners and re-rendering logic

## Policy Block

- SHOULD Visual effects SHOULD respond to theme changes and viewport resizing through appropriate event listeners and re-rendering logic
