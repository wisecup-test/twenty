# Standardize Public API Contract Definitions with TypeScript Type Exports: Public Contracts Include
...
1. MAY: Public API contracts MAY include utility types for common patterns (e.g., pagination, filtering, sorting) to promote consistency

## Policy Block

- MAY Public API contracts MAY include utility types for common patterns (e.g., pagination, filtering, sorting) to promote consistency
