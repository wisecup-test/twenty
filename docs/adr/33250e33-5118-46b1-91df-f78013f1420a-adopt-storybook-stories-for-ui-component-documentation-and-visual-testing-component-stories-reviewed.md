# Adopt Storybook Stories for UI Component Documentation and Visual Testing: Component Stories Reviewed
...
1. SHOULD: Component stories SHOULD be reviewed as part of the code review process for new components

## Policy Block

- SHOULD Component stories SHOULD be reviewed as part of the code review process for new components
