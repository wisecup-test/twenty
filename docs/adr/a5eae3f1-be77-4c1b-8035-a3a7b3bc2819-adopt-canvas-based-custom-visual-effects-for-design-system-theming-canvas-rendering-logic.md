# Adopt Canvas-Based Custom Visual Effects for Design System Theming: Canvas Rendering Logic
...
1. SHOULD: Canvas rendering logic SHOULD be separated from component presentation logic to enable reusability across different themed sections

## Policy Block

- SHOULD Canvas rendering logic SHOULD be separated from component presentation logic to enable reusability across different themed sections
