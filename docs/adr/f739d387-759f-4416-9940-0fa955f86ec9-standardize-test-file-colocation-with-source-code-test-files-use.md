# Standardize Test File Colocation with Source Code: Test Files Use
...
1. MUST: Test files MUST use the naming convention <module-name>.test.ts or <module-name>.test.tsx

## Policy Block

- MUST Test files MUST use the naming convention <module-name>.test.ts or <module-name>.test.tsx
