# Adopt Zapier Integration Pattern for External API Exposure: External Endpoints Use
...
1. MUST: All external API endpoints MUST use strongly-typed data structures defined in dedicated type definition files

## Policy Block

- MUST All external API endpoints MUST use strongly-typed data structures defined in dedicated type definition files
