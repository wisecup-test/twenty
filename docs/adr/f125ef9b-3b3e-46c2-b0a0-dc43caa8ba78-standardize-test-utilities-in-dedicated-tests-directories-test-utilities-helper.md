# Standardize Test Utilities in Dedicated __tests__ Directories: Test Utilities Helper
...
1. SHOULD: Test utilities and helper functions shared across multiple test files SHOULD be extracted to a common test utilities directory

## Policy Block

- SHOULD Test utilities and helper functions shared across multiple test files SHOULD be extracted to a common test utilities directory
