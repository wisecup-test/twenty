# Adopt Zapier Integration Pattern for External API Exposure: Zapier Triggers Implement
...
1. MUST: Zapier triggers MUST implement standard patterns including list_record_ids, find_object_names, and trigger_record for data discovery and synchronization

## Policy Block

- MUST Zapier triggers MUST implement standard patterns including list_record_ids, find_object_names, and trigger_record for data discovery and synchronization
