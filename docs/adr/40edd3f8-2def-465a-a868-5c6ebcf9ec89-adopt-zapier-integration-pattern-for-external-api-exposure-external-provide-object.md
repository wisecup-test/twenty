# Adopt Zapier Integration Pattern for External API Exposure: External Provide Object
...
1. MUST: External APIs MUST provide object metadata discovery mechanisms to enable dynamic integration configuration

## Policy Block

- MUST External APIs MUST provide object metadata discovery mechanisms to enable dynamic integration configuration
