# Standardize Public API Contract Definitions with TypeScript Type Exports: Internal Implementation Types
...
1. MUST_NOT: Internal implementation types MUST NOT be directly exposed as public API contracts without explicit export declarations

## Policy Block

- MUST_NOT Internal implementation types MUST NOT be directly exposed as public API contracts without explicit export declarations
