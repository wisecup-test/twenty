# Standardize Test Utilities in Dedicated __tests__ Directories: Test Files Include
...
1. MAY: Test files MAY include integration tests when testing utility functions that interact with multiple modules

## Policy Block

- MAY Test files MAY include integration tests when testing utility functions that interact with multiple modules
