# Adopt Zapier Integration Pattern for External API Exposure: Public Documentation Located
...
1. SHOULD: Public API documentation SHOULD be co-located with integration code in website sections for discoverability

## Policy Block

- SHOULD Public API documentation SHOULD be co-located with integration code in website sections for discoverability
