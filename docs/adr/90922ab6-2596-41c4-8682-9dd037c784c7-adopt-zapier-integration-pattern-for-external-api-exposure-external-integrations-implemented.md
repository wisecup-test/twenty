# Adopt Zapier Integration Pattern for External API Exposure: External Integrations Implemented
...
1. MUST: External API integrations MUST be implemented as separate packages with clear boundaries from core application logic

## Policy Block

- MUST External API integrations MUST be implemented as separate packages with clear boundaries from core application logic
