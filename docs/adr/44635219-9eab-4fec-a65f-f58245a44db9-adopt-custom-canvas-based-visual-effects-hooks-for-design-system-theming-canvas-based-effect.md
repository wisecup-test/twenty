# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Canvas Based Effect
...
1. MUST: Canvas-based effect hooks MUST handle their own lifecycle management including canvas creation, animation frame scheduling, and cleanup on unmount

## Policy Block

- MUST Canvas-based effect hooks MUST handle their own lifecycle management including canvas creation, animation frame scheduling, and cleanup on unmount
