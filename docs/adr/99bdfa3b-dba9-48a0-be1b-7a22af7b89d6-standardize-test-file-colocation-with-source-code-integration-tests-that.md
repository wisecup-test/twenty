# Standardize Test File Colocation with Source Code: Integration Tests That
...
1. MAY: Integration tests that span multiple modules MAY be placed in a dedicated integration test directory at the package level

## Policy Block

- MAY Integration tests that span multiple modules MAY be placed in a dedicated integration test directory at the package level
