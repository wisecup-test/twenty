# Implement Cache Layer for External API Relationship Data: Cache Implementations Not
...
1. MUST_NOT: Cache implementations MUST NOT expose stale data beyond configured TTL boundaries without explicit user acknowledgment

## Policy Block

- MUST_NOT Cache implementations MUST NOT expose stale data beyond configured TTL boundaries without explicit user acknowledgment
