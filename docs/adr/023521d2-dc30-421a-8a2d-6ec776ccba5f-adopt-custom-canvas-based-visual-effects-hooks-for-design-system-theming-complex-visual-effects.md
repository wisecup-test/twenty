# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Complex Visual Effects
...
1. SHOULD: Complex visual effects (halftone processing, animated graphics) SHOULD use canvas APIs rather than CSS-only solutions for performance-critical rendering

## Policy Block

- SHOULD Complex visual effects (halftone processing, animated graphics) SHOULD use canvas APIs rather than CSS-only solutions for performance-critical rendering
