# Standardize Module Export Patterns for Component and Utility Libraries: Visual Components Theme
...
1. MUST: Visual components and theme-related exports (such as css-variables.ts) MUST be accessible through standardized module paths

## Policy Block

- MUST Visual components and theme-related exports (such as css-variables.ts) MUST be accessible through standardized module paths
