# Adopt Jest as Standard Testing Framework for TypeScript Components: Typescript Test Files
...
1. MUST: All TypeScript test files MUST use Jest as the testing framework and MUST be placed in __tests__ directories with .test.ts extension

## Policy Block

- MUST All TypeScript test files MUST use Jest as the testing framework and MUST be placed in __tests__ directories with .test.ts extension
