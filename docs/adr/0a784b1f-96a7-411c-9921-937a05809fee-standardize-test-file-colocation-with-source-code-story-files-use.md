# Standardize Test File Colocation with Source Code: Story Files Use
...
1. MUST: Story files MUST use the naming convention <ComponentName>.stories.tsx

## Policy Block

- MUST Story files MUST use the naming convention <ComponentName>.stories.tsx
