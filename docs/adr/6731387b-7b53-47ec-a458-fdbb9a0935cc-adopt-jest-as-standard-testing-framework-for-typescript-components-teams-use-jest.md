# Adopt Jest as Standard Testing Framework for TypeScript Components: Teams Use Jest
...
1. MAY: Teams MAY use Jest's snapshot testing capabilities for UI component regression testing

## Policy Block

- MAY Teams MAY use Jest's snapshot testing capabilities for UI component regression testing
