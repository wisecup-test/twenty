# Adopt Storybook Stories for UI Component Documentation and Visual Testing: Story Files Follow
...
1. MUST: Story files MUST follow the naming convention `{ComponentName}.stories.tsx`

## Policy Block

- MUST Story files MUST follow the naming convention `{ComponentName}.stories.tsx`
