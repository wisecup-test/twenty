# Standardize Public API Contract Definitions with TypeScript Type Exports: Integration Packages Zapier
...
1. SHOULD: Integration packages (e.g., Zapier, webhooks) SHOULD maintain separate type definition files for each major API resource or trigger

## Policy Block

- SHOULD Integration packages (e.g., Zapier, webhooks) SHOULD maintain separate type definition files for each major API resource or trigger
