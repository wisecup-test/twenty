# Adopt Zapier Integration Pattern for External API Exposure: Integration Packages Use
...
1. SHOULD: Integration packages SHOULD use modern build tooling (e.g., Vite) to ensure compatibility with external platform requirements

## Policy Block

- SHOULD Integration packages SHOULD use modern build tooling (e.g., Vite) to ensure compatibility with external platform requirements
