# Standardize Module Export Patterns for Component and Utility Libraries: Module Exports Organized
...
1. SHOULD: Module exports SHOULD be organized by functional domain (components, utils, hooks, types) with separate index files for each subdomain

## Policy Block

- SHOULD Module exports SHOULD be organized by functional domain (components, utils, hooks, types) with separate index files for each subdomain
