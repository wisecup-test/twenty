# Standardize Public API Contract Definitions with TypeScript Type Exports: Breaking Changes Public
...
1. MUST: Breaking changes to public API contracts MUST follow semantic versioning and include deprecation notices

## Policy Block

- MUST Breaking changes to public API contracts MUST follow semantic versioning and include deprecation notices
