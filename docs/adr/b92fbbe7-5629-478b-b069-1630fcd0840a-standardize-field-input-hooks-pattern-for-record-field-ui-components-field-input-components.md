# Standardize Field Input Hooks Pattern for Record Field UI Components: Field Input Components
...
1. MUST: All field input components in the record-field UI layer MUST use dedicated custom hooks following the naming pattern 'useOpen[FieldType]FieldInput'

## Policy Block

- MUST All field input components in the record-field UI layer MUST use dedicated custom hooks following the naming pattern 'useOpen[FieldType]FieldInput'
