# Standardize Module Export Patterns for Component and Utility Libraries: Consumers Not Import
...
1. MUST_NOT: Consumers MUST NOT import directly from internal implementation files; all imports MUST use the public module exports

## Policy Block

- MUST_NOT Consumers MUST NOT import directly from internal implementation files; all imports MUST use the public module exports
