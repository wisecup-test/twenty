# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Effect Hooks Accept
...
1. MAY: Effect hooks MAY accept configuration parameters to customize visual appearance while maintaining consistent behavior patterns

## Policy Block

- MAY Effect hooks MAY accept configuration parameters to customize visual appearance while maintaining consistent behavior patterns
