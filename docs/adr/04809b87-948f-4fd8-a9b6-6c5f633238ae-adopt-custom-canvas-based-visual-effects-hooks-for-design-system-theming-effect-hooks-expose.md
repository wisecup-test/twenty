# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Effect Hooks Expose
...
1. SHOULD: Effect hooks SHOULD expose minimal, focused APIs that return refs or state needed by the consuming component

## Policy Block

- SHOULD Effect hooks SHOULD expose minimal, focused APIs that return refs or state needed by the consuming component
