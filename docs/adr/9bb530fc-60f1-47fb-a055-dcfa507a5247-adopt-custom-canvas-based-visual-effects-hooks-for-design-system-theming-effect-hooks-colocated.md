# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Effect Hooks Colocated
...
1. MUST: Effect hooks MUST be colocated with their consuming components in a 'hooks' subdirectory within the component or section directory

## Policy Block

- MUST Effect hooks MUST be colocated with their consuming components in a 'hooks' subdirectory within the component or section directory
