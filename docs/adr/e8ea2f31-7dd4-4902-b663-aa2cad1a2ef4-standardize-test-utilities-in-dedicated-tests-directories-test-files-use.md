# Standardize Test Utilities in Dedicated __tests__ Directories: Test Files Use
...
1. MUST: Test files MUST use the .test.ts or .test.tsx extension to be recognized by the test runner

## Policy Block

- MUST Test files MUST use the .test.ts or .test.tsx extension to be recognized by the test runner
