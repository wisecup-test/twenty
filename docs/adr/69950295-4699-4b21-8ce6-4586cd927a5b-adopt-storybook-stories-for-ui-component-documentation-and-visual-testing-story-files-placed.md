# Adopt Storybook Stories for UI Component Documentation and Visual Testing: Story Files Placed
...
1. MUST: Story files MUST be placed in a `__stories__` directory adjacent to the component implementation

## Policy Block

- MUST Story files MUST be placed in a `__stories__` directory adjacent to the component implementation
