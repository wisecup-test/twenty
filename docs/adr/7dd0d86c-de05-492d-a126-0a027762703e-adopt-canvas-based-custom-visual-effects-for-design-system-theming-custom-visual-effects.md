# Adopt Canvas-Based Custom Visual Effects for Design System Theming: Custom Visual Effects
...
1. MUST: Custom visual effects requiring pixel-level manipulation or procedural generation MUST be implemented using HTML5 Canvas API

## Policy Block

- MUST Custom visual effects requiring pixel-level manipulation or procedural generation MUST be implemented using HTML5 Canvas API
