# Standardize Module Export Patterns for Component and Utility Libraries: Library Modules Define
...
1. MUST: All library modules MUST define explicit public API contracts through index files (index.ts, index.tsx) that re-export public components and utilities

## Policy Block

- MUST All library modules MUST define explicit public API contracts through index files (index.ts, index.tsx) that re-export public components and utilities
