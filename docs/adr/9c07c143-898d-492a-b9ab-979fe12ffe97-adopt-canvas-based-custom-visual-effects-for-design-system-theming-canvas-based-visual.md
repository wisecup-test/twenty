# Adopt Canvas-Based Custom Visual Effects for Design System Theming: Canvas Based Visual
...
1. MUST: Canvas-based visual effects MUST be encapsulated in custom React hooks following the naming pattern 'use-[effect-name]-[canvas|backdrop]'

## Policy Block

- MUST Canvas-based visual effects MUST be encapsulated in custom React hooks following the naming pattern 'use-[effect-name]-[canvas|backdrop]'
