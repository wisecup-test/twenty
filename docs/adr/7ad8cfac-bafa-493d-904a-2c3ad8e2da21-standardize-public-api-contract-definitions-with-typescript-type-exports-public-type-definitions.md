...
1. SHOULD: Public API type definitions SHOULD include JSDoc comments documenting field purposes, constraints, and examples

## Policy Block

- SHOULD Public API type definitions SHOULD include JSDoc comments documenting field purposes, constraints, and examples
