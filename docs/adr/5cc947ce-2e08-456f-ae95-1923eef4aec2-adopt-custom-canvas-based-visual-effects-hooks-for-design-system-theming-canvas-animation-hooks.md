# Adopt Custom Canvas-Based Visual Effects Hooks for Design System Theming: Canvas Animation Hooks
...
1. SHOULD: Canvas animation hooks SHOULD use requestAnimationFrame for smooth 60fps rendering and properly cancel frames on cleanup

## Policy Block

- SHOULD Canvas animation hooks SHOULD use requestAnimationFrame for smooth 60fps rendering and properly cancel frames on cleanup
