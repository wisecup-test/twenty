# Implement Cache Layer for External API Relationship Data: External Integrations That
...
1. MUST: External API integrations that expose relational data MUST implement a cache layer to store relationship metadata and reduce redundant API calls

## Policy Block

- MUST External API integrations that expose relational data MUST implement a cache layer to store relationship metadata and reduce redundant API calls
