# Adopt Canvas-Based Custom Visual Effects for Design System Theming: Canvas Based Hooks
...
1. MUST: Canvas-based hooks MUST handle cleanup and resource disposal in useEffect return callbacks to prevent memory leaks

## Policy Block

- MUST Canvas-based hooks MUST handle cleanup and resource disposal in useEffect return callbacks to prevent memory leaks
