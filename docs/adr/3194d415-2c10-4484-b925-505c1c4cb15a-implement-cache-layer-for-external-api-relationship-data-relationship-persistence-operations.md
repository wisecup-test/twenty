# Implement Cache Layer for External API Relationship Data: Relationship Persistence Operations
...
1. MUST: Relationship persistence operations MUST update or invalidate relevant cache entries to maintain consistency

## Policy Block

- MUST Relationship persistence operations MUST update or invalidate relevant cache entries to maintain consistency
