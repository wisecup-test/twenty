# Standardize Test File Colocation with Source Code: Storybook Story Files
...
1. MUST: Storybook story files MUST be placed in __stories__ subdirectories adjacent to the components they document

## Policy Block

- MUST Storybook story files MUST be placed in __stories__ subdirectories adjacent to the components they document
