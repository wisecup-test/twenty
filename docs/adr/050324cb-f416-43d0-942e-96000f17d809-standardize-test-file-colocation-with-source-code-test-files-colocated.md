# Standardize Test File Colocation with Source Code: Test Files Colocated
...
1. MUST: Test files MUST be colocated with source code in __tests__ subdirectories adjacent to the modules they test

## Policy Block

- MUST Test files MUST be colocated with source code in __tests__ subdirectories adjacent to the modules they test
