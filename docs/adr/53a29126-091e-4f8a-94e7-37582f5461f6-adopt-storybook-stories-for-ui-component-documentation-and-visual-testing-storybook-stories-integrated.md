# Adopt Storybook Stories for UI Component Documentation and Visual Testing: Storybook Stories Integrated
...
1. SHOULD: Storybook stories SHOULD be integrated into the CI/CD pipeline for visual regression testing

## Policy Block

- SHOULD Storybook stories SHOULD be integrated into the CI/CD pipeline for visual regression testing
